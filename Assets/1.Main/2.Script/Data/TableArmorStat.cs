...
{//Type	Id	grade	Defence	Damage	ReloadTime	AttackSpeed	CriRate	Speed
    ...
    { //는 폐기 후 아이템의 정보는 한개씩 가져오되 다른 메서드 구현하여 방어구 수치값들만 +하여 적용하는 방식으로 하면 될것 같음.
        ...
        ArmorData armorstat = new ArmorData(armordata.Type, armordata.Id, armordata.Grade, armordata.Defence, armordata.Damage, armordata.HP, armordata.AttackSpeed, armordata.CriRate, armordata.Speed, armordata.armorType,armordata.Image,armordata.Info,armordata.ItemType,armordata.Price);
        return armorstat;
    }
